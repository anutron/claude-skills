---
name: logo
description: Use when the user wants to create or generate a logo
---
# Logo Generation
...
- Layer elements: ambient light then structure then hero element then accents
...
- If there is an existing logo, include it as the "Current" option
...
2. Add the logo to the top of the project README, centered at 120px width:
   ```html
...
5. **Layered depth** — Background then ambient glow then structure then hero then sparkle/accent
